...
float westlon = 13.377742767333984; // the most left point
float northlat = 52.52233148148175; // the most top point
float southlat = 52.50650479924129; // the most bottom point
float eastlon = 13.398599624633789; // the most right point
...
void setup() {
  ...
  xml = loadXML("RK_gpx _2013-11-19_1606.gpx"); // this is the file
