...
// Berlin Mitte
float northlat = 52.538361; // the most top point
float westlon = 13.375790; // the most left point
float southlat = 52.529747; // the most bottom point
float eastlon =  13.387678; // the most right point
...
void setup() {
  ...
  xml = loadXML("RK_gpx _2013-11-19_1339.gpx"); // this is the file
