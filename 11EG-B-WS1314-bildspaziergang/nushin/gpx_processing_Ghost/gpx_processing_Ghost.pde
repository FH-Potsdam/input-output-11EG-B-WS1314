 ...
 * Friedrichshain
 */
float northlat = 52.516116401541495; // the most top point
float westlon = 13.448638916015625; // the most left point
float southlat = 52.50310889376855; // the most bottom point
float eastlon = 13.476276397705078; // the most right point
...
void setup() {
  ...
  xml = loadXML("Ghost eins.gpx"); // this is the file
