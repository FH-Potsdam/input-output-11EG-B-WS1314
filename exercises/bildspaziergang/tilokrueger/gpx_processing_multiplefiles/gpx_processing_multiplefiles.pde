...
float northlat = 52.52984898000442; // the most top point
float westlon = 13.441686630249023; // the most left point
float southlat = 52.5197724373965; // the most bottom point
float eastlon = 13.462715148925781; // the most right point
/**
...
void setup() {
  ...
  size(1200, 600);
  noLoop();
  beginRecord(PDF, "filename11.pdf"); 
   ...
   */
  gpxfiles.add("2013-11-18-1628.gpx");
}
