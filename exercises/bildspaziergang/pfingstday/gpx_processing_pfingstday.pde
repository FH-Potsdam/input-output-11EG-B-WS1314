...
/**
 * This is Berlin Prenzlauer Berg
 */
float northlat = 52.55874252908704; // the most top point
float westlon = 13.42477798461914; // the most left point
float southlat = 52.53781312958724; // the most bottom point
float eastlon = 13.43902587890625; // the most right point
...
void setup() {
  ...
  xml = loadXML("2013-11-19_GPS_Anweisung_Nushin.gpx"); // this is the file
