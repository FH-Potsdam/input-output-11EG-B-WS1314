...
//This is Potsdam Babelsberg
float northlat = 52.389500000; // the most top point
float westlon = 13.105522000; // the most left point
float southlat = 52.094300000; // the most bottom point
float eastlon = 13.100510000; // the most right point
...
void setup() {
  ...
  xml = loadXML("anweisung_martin.gpx"); // this is the file
